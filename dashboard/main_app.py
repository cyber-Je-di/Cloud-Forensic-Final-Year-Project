...
def dashboard():
    ...
    # The old chart_stats is no longer needed as alert_severity_data will be used for the alert chart
    # chart_stats = {
    #     "Critical": 12,
    #     "High": 28,
    #     "Medium": 45,
    ...
    current_total_alerts, current_security_events, alert_severity_data = load_alerts_data(
    ...
    return render_template(
        ...
        # logs_per_tenant=logs_per_tenant_for_chart, # Old key, changing for clarity
        ...
        alert_severity_data=alert_severity_data, # New, for alert chart
        logs_per_tenant_chart_data=logs_per_tenant_for_chart, # New key for logs chart data
        logout_url=url_for("logout")
    )
